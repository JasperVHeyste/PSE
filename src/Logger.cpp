...
void Logger::logBWPprinter2(Job *currentjob, BWprinter *p, ostream &outputstream) {
...
void Logger::logColorprinter(Job *currentjob, Colorprinter *p, ostream &outputstream) {
...
void Logger::logScanner(Job *currentjob, Scanner *s, ostream &outputstream) {
